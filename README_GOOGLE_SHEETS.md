...
- ✅ **名札の管理**: 名札の追加、編集、色のカスタマイズ、削除
- ✅ **作業項目の管理**: 作業項目の追加、編集、上下移動、削除
...
- ✅ **Undo履歴**: PropertiesServiceを使って最大20回の履歴を保持
